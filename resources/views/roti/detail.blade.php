        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Laporan Detail Stok Roti</h4>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($laporan as $item)
                                    @foreach ($item['detail'] as $detail)
                                        ...
                                        <div class="modal fade" id="modalDatang{{ $detail['id'] }}" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="{{ route('roti.masuk') }}" method="POST">
                                                        @csrf
                                                        ...
                                                        <div class="modal-body">
                                                            <p><b>{{ $item['roti']->nama }}</b>
                                                                ({{ $item['roti']->kd_roti }})
                                                            </p>
                                                            <input type="hidden" name="roti_id"
                                                                value="{{ $item['roti']->id }}">
                                        ...
                                        <div class="modal fade" id="modalTerpakai{{ $detail['id'] }}" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="{{ route('roti.keluar') }}" method="POST">
                                                        @csrf
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">
                                        ...
                                        {{-- <div class="modal fade" id="modalFIFO{{ $detail['id'] }}" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p><b>{{ $item['roti']->nama }}</b> ({{ $item['roti']->kd_roti }})
                                                        </p>
                                ...
                                <div class="modal fade" id="modalFIFO{{ $detail['id'] }}" tabindex="-1">
                                    <div class="modal-dialog modal-lg"> {{-- Bisa modal-lg atau modal-xl --}}
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p><b>{{ $item['roti']->nama }}</b> ({{ $item['roti']->kd_roti }})</p>
